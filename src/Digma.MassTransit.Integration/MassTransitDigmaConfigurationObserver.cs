...
{
    public static IServiceCollection UseDigmaMassTransitConsumeObserver(this IServiceCollection serviceCollection, Action<MassTransitDigmaConfigurationObserver> action)
    {
